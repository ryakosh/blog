...
description: This is for programmers who want to get familiar with PHP quickly or people who experienced with it before but forgot some of it's syntax.
date: 2022-09-26
tags: 
  - backend
  - php
  - starter-pack
  - web-development
banner: ./PHP-Starter-Pack.png
---
![PHP Starter Pack hero](./PHP-Starter-Pack.png)
